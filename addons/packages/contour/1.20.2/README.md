...
| `contour.configFileContents` | (none) | The YAML contents of the Contour config file. See [the Contour configuration documentation](https://projectcontour.io/docs/v1.20.2/configuration/#configuration-file) for more information. |
...
See [the Contour configuration documentation](https://projectcontour.io/docs/v1.20.2/configuration/#configuration-file) for full details on the available options.
...
Contour supports both the [Ingress API](https://kubernetes.io/docs/concepts/services-networking/ingress/) and the Contour-specific [HTTPProxy API](https://projectcontour.io/docs/v1.20.2/config/fundamentals/) for configuring traffic routing rules.
...
See Contour's [troubleshooting page](https://projectcontour.io/docs/v1.20.2/troubleshooting/) for information on troubleshooting Contour.
