...
func main() {
	...
	runCommand("ytt --data-values-file supplychain-example-values.yaml --ignore-unknown-comments -f example_sc/kpack-dependencies.yaml --output-files test_sc")
	...
	runCommand("kubectl apply -f test_sc/kpack-dependencies.yaml")
