...
func init() {
	...
	flag.StringVar(&packageVersion, "version", "0.5.4", "the version of the package to test")
}
...
var _ = BeforeSuite(func() {
	...
	whereaboutsPackage = addonPackage{
		...
		version:            "0.5.4",
		fullVersion:        utils.TanzuPackageAvailableVersionWithVersionSubString(whereaboutsPackageName, "0.5.4"),
		installedNamespace: "default",
