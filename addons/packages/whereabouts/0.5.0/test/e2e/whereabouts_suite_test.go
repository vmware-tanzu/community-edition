...
func init() {
	...
	flag.StringVar(&packageVersion, "version", "0.5.0", "the version of the package to test")
}
...
var _ = BeforeSuite(func() {
	...
	multusCNIPackage = addonPackage{
		...
		version:            "3.7.1",
		fullVersion:        utils.TanzuPackageAvailableVersion(multusCNIpackageName),
	...
	whereaboutsPackage = addonPackage{
		...
		version:            "0.5.0",
		fullVersion:        utils.TanzuPackageAvailableVersion(whereaboutsPackageName),
		installedNamespace: "default",
