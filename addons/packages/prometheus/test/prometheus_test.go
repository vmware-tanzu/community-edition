...
var _ = Describe("Prometheus Addon E2E Test", func() {
	Specify("check prometheus is running", func() {
		var result int
		...
		for {
			resp, _ := http.Get(cmdHelperUp.CommandArgs["prometheus-health-check"][1])
			if resp != nil {
