...
TanzuFrameworkPluginDestinationRepo=""
TanzuFrameworkCliPluginSourceRepoVersion=""
...
ParseConfig()
{
  ...
  TanzuFrameworkCliPluginSourceRepo=$(echo "${tanzuFrameworkCliPluginSourceRepo}:${tanzuFrameworkCliPluginSourceRepoVersion}")
  ...
  TanzuFrameworkCliPluginDestinationInTCERepo=$(echo "${TanzuFrameworkCliPluginDestinationInTCERepo}${TanzuFrameworkCliPluginDestinationVersion}")
  ...
  TceCliPluginReleaseManifestPath=$(echo "${tceCliPluginReleaseRepo}:${tceReleaseVersion}")
...
Help()
{
  ...
  echo
  echo "Usage: copy.sh --source example.com/biz --destination example.com/baz"
  echo "options:"
  echo "-h,--help         Help"
