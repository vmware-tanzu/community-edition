This section describes installing the [cert-manager](https://tanzucommunityedition.io/docs/v0.11/package-readme-cert-manager-1.6.1/) package in your cluster as an example of package installation. For detailed instruction on package management, see [Work with Packages](../package-management).
