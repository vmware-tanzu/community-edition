...
In the video, you can see by the color of the output that my context is pointing to the workload cluster: tce-workload-cluster-1-admin@tce-workload-cluster-1. This is the one I will be using for this demo.
