# Configure the Kubernetes Network and Proxies {#network}
...
## Configure Identity Management {#id-mgmt}
...
## Register with Tanzu Mission Control {#register-tmc}
...
## Finalize the Deployment {#finalize-deployment}
