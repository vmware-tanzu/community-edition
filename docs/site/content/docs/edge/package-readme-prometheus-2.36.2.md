...
| `prometheus.deployment.rollingUpdate.maxUnavailable`    | false                        | 25%     | Number of maxUnavailable pods when prometheus is upgrading, It only work when updateStrategy is RollingUpdate                       |
| `prometheus.deployment.rollingUpdate.maxSurge`          |  false                      | 25%     | Number of maxSurge pods when prometheus is upgrading, It only work when updateStrategy is RollingUpdate                        |
