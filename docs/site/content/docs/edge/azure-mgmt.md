...
1. Run the `az vm image terms accept` command, specifying the `--plan` and your Subscription ID.
   ...
   In Tanzu Community Edition 0.12.0, the default cluster image `--plan` value is `k8s-1dot21dot5-ubuntu-2004`, based on Kubernetes version 1.21 and the machine OS, Ubuntu 20.04. Run the following command:
