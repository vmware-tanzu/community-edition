...
1. Configure Harbor Package
   ...
   Download the values.yaml file from [addons/packages/harbor/2.4.2/bundle/config/values.yaml](https://github.com/vmware-tanzu/community-edition/blob/main/addons/packages/harbor/2.4.2/bundle/config/values.yaml) to check all configuration values for Harbor Package and rename it to `harbor-values.yaml`.
