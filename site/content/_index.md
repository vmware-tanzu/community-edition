...
backgrounds:
  ...
  team: dark-blue
hero:
  banner: /img/heros/TODO(joshrosso).png
  headline: Build Application Platforms with Kubernetes
  content: Tanzu Community Edition (TCE) is an open source Kubernetes distribution and modular application platform.
  cta_link1:
