...
.PHONY: install-cli
install-cli:
	TKG_DEFAULT_BOM_IMAGE_REPO=${TKG_DEFAULT_BOM_IMAGE_REPO} TKG_DEFAULT_BOM_IMAGE_PATH=${TKG_DEFAULT_BOM_IMAGE_PATH} \
	TKG_DEFAULT_BOM_IMAGE_TAG=${TKG_DEFAULT_BOM_IMAGE_TAG} TANZU_CORE_REPO_HASH="f1c12dac0ea8a87e57c9a47fcebaa286afa107b5" BUILD_EDITION="tce" \
