...
import WorkloadClusterWizard from './views/workload-cluster/WorkloadClusterWizard';
                ...
                <div cds-layout="vertical align:stretch">
                    <div cds-layout="grid gap:md gap@md:lg p:lg p@sm:lg p-y@lg:lg container:fill container:left">
                        <Routes>
                            ...
                            <Route path={NavRoutes.WORKLOAD_CLUSTER_WIZARD} element={<WorkloadClusterWizard />}></Route>
