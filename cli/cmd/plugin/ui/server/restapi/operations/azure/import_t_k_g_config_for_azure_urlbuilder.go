...
func (o *ImportTKGConfigForAzureURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/azure/config/import"
...
func (o *ImportTKGConfigForAzureURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ImportTKGConfigForAzureURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ImportTKGConfigForAzureURL")
	}
