...
func (o *GetAzureRegionsURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/azure/regions"
...
func (o *GetAzureRegionsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAzureRegionsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAzureRegionsURL")
	}
