...
type GetAzureInstanceTypesURL struct {
	Location string
...
func (o *GetAzureInstanceTypesURL) Build() (*url.URL, error) {
	...
	if location != "" {
		...
		return nil, errors.New("location is required on GetAzureInstanceTypesURL")
	}
...
func (o *GetAzureInstanceTypesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAzureInstanceTypesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAzureInstanceTypesURL")
	}
