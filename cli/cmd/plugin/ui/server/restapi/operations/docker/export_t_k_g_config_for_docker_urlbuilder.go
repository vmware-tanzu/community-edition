...
func (o *ExportTKGConfigForDockerURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/docker/config/export"
...
func (o *ExportTKGConfigForDockerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ExportTKGConfigForDockerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ExportTKGConfigForDockerURL")
	}
