...
func (o *GetAviServiceEngineGroupsURL) Build() (*url.URL, error) {
	...
	var _path = "/api/avi/serviceenginegroups"
...
func (o *GetAviServiceEngineGroupsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAviServiceEngineGroupsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAviServiceEngineGroupsURL")
	}
