...
func (o *ApplyTKGConfigForAWSURL) WithBasePath(bp string) *ApplyTKGConfigForAWSURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ApplyTKGConfigForAWSURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ApplyTKGConfigForAWSURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ApplyTKGConfigForAWSURL")
	}
