...
func (o *ExportTKGConfigForAWSURL) WithBasePath(bp string) *ExportTKGConfigForAWSURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ExportTKGConfigForAWSURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/aws/config/export"
...
func (o *ExportTKGConfigForAWSURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ExportTKGConfigForAWSURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ExportTKGConfigForAWSURL")
	}
