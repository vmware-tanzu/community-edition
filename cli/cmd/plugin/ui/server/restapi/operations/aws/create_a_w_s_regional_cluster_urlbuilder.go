...
func (o *CreateAWSRegionalClusterURL) WithBasePath(bp string) *CreateAWSRegionalClusterURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateAWSRegionalClusterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateAWSRegionalClusterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateAWSRegionalClusterURL")
	}
