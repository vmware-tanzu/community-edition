...
func (o *ImportTKGConfigForAWSURL) WithBasePath(bp string) *ImportTKGConfigForAWSURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ImportTKGConfigForAWSURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ImportTKGConfigForAWSURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ImportTKGConfigForAWSURL")
	}
