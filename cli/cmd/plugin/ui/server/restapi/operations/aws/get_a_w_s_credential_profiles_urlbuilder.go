...
func (o *GetAWSCredentialProfilesURL) WithBasePath(bp string) *GetAWSCredentialProfilesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAWSCredentialProfilesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAWSCredentialProfilesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAWSCredentialProfilesURL")
	}
