...
// GetVSphereNetworksParams contains all the bound params for the get v sphere networks operation
...
func (o *GetVSphereNetworksParams) bindDc(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
