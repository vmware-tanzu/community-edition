...
func (o *GetVSphereComputeResourcesURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/compute"
...
func (o *GetVSphereComputeResourcesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetVSphereComputeResourcesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetVSphereComputeResourcesURL")
	}
