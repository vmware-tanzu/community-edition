...
// GetVSphereResourcePoolsParams contains all the bound params for the get v sphere resource pools operation
...
func (o *GetVSphereResourcePoolsParams) bindDc(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
