...
// GetVSphereFoldersParams contains all the bound params for the get v sphere folders operation
...
func (o *GetVSphereFoldersParams) bindDc(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
