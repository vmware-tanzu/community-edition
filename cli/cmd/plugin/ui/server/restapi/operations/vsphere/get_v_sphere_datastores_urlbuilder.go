...
func (o *GetVSphereDatastoresURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/datastores"
...
func (o *GetVSphereDatastoresURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetVSphereDatastoresURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetVSphereDatastoresURL")
	}
