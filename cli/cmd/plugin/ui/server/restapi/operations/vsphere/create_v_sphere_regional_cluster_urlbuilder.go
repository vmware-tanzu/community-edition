...
func (o *CreateVSphereRegionalClusterURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/create"
...
func (o *CreateVSphereRegionalClusterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateVSphereRegionalClusterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateVSphereRegionalClusterURL")
	}
