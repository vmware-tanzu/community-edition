...
// GetVSphereComputeResourcesParams contains all the bound params for the get v sphere compute resources operation
...
func (o *GetVSphereComputeResourcesParams) bindDc(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
