...
func (o *ExportTKGConfigForVsphereURL) WithBasePath(bp string) *ExportTKGConfigForVsphereURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ExportTKGConfigForVsphereURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/config/export"
...
func (o *ExportTKGConfigForVsphereURL) String() string {
...
func (o *ExportTKGConfigForVsphereURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ExportTKGConfigForVsphereURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ExportTKGConfigForVsphereURL")
	}
