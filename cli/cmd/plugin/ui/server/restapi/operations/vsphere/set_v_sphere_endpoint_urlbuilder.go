...
func (o *SetVSphereEndpointURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere"
...
func (o *SetVSphereEndpointURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on SetVSphereEndpointURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on SetVSphereEndpointURL")
	}
