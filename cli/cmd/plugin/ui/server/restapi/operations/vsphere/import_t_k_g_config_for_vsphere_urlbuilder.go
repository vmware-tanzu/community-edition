...
func (o *ImportTKGConfigForVsphereURL) WithBasePath(bp string) *ImportTKGConfigForVsphereURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ImportTKGConfigForVsphereURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/config/import"
...
func (o *ImportTKGConfigForVsphereURL) String() string {
...
func (o *ImportTKGConfigForVsphereURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ImportTKGConfigForVsphereURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ImportTKGConfigForVsphereURL")
	}
