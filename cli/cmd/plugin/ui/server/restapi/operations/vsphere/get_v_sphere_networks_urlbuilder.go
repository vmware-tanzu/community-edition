...
func (o *GetVSphereNetworksURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/networks"
...
func (o *GetVSphereNetworksURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetVSphereNetworksURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetVSphereNetworksURL")
	}
