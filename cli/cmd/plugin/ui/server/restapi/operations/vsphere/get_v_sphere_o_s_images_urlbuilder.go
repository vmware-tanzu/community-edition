...
func (o *GetVSphereOSImagesURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/osimages"
...
func (o *GetVSphereOSImagesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetVSphereOSImagesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetVSphereOSImagesURL")
	}
