...
func (o *VerifyLdapCloseConnectionURL) WithBasePath(bp string) *VerifyLdapCloseConnectionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *VerifyLdapCloseConnectionURL) String() string {
...
func (o *VerifyLdapCloseConnectionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on VerifyLdapCloseConnectionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on VerifyLdapCloseConnectionURL")
	}
