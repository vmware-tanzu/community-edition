...
func (o *VerifyLdapGroupSearchURL) WithBasePath(bp string) *VerifyLdapGroupSearchURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *VerifyLdapGroupSearchURL) Build() (*url.URL, error) {
	...
	var _path = "/api/ldap/groups/search"
...
func (o *VerifyLdapGroupSearchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on VerifyLdapGroupSearchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on VerifyLdapGroupSearchURL")
	}
