...
// VerifyLdapCloseConnectionParams contains all the bound params for the verify ldap close connection operation
...
func (o *VerifyLdapCloseConnectionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
