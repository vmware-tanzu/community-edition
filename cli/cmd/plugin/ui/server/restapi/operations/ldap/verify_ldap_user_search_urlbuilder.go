...
func (o *VerifyLdapUserSearchURL) WithBasePath(bp string) *VerifyLdapUserSearchURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *VerifyLdapUserSearchURL) Build() (*url.URL, error) {
	...
	var _path = "/api/ldap/users/search"
...
func (o *VerifyLdapUserSearchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on VerifyLdapUserSearchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on VerifyLdapUserSearchURL")
	}
