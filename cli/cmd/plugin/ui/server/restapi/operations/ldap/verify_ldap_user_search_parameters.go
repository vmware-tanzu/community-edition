...
// VerifyLdapUserSearchParams contains all the bound params for the verify ldap user search operation
...
func (o *VerifyLdapUserSearchParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
