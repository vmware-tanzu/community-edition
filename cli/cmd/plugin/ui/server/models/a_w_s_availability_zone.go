...
// ContextValidate validates this a w s availability zone based on context it is used
func (m *AWSAvailabilityZone) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
