...
// ContextValidate validate this a w s vpc based on the context it is used
...
func (m *AWSVpc) contextValidateAzs(ctx context.Context, formats strfmt.Registry) error {
